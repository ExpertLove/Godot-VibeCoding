...
> See [references/damage-numbers.md](references/damage-numbers.md) for the full GDScript DamageNumber scene + pooled spawner.
...
> See [references/notifications.md](references/notifications.md) for the full GDScript stack with auto-dismiss timers.
...
> See [references/minimap.md](references/minimap.md) for the SubViewport setup, MinimapCamera GDScript, and circular-mask shader.
...
> See [references/interaction-prompts.md](references/interaction-prompts.md) for the full GDScript prompt + Interactable Area2D pair.
