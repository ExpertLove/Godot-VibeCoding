...
> See [references/bsp-dungeons.md](references/bsp-dungeons.md) for the full recursive partition + room placement + corridor connection algorithm in GDScript.
...
> See [references/cellular-automata.md](references/cellular-automata.md) for the full GDScript implementation with TileMapLayer integration.
...
> See [references/wave-function-collapse.md](references/wave-function-collapse.md) for concept overview and a simplified GDScript implementation.
