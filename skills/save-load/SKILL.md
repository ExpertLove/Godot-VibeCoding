...
> See [references/configfile.md](references/configfile.md) for the full GDScript settings save/load + typical settings-menu wiring.
...
> See [references/json-saves.md](references/json-saves.md) for the full GDScript save/load implementation, including FileAccess wrapping and error handling.
