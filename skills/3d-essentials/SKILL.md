...
> See [references/materials-and-lighting-recipes.md](references/materials-and-lighting-recipes.md) for the full GDScript recipes (basic material setup, emissive flash, per-instance duplicate, dynamic OmniLight3D explosion).
...
> See [references/materials-and-lighting-recipes.md](references/materials-and-lighting-recipes.md#dynamic-point-light) for the full GDScript recipe.
...
> See [references/materials-and-lighting-recipes.md](references/materials-and-lighting-recipes.md) for the runtime-assignment GDScript code path (the Inspector setup above is the typical case).
...
> See [references/fog-recipes.md](references/fog-recipes.md) for the full GDScript recipes — depth/height fog setup, volumetric fog parameters and performance notes, and FogVolume placement.
...
> See [references/decals.md](references/decals.md) for the scene setup, runtime spawning recipe (GDScript), and the per-renderer decal limits.
