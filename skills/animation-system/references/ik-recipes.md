...
Reference for `skills/animation-system/SKILL.md` — full GDScript recipes for IKModifier3D solvers (Godot 4.6+).
...
> **Note:** `IKModifier3D` was introduced in Godot 4.6 beta 1 and is still being finalized. Property names and subclass count may change before the stable release. See the [4.6 release announcement](https://godotengine.org/article/dev-snapshot-godot-4-6-beta-1/) for details.
