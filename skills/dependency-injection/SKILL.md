...
> See [references/autoloads.md](references/autoloads.md) for the full AudioManager example (SFX + crossfade music) in GDScript.
...
> See [references/export-injection.md](references/export-injection.md) for full `@export` patterns (GDScript) and lifecycle notes.
...
> See [references/service-locator.md](references/service-locator.md) for the full Service Locator (GDScript) with typed helper methods.
...
> See [references/scene-injection.md](references/scene-injection.md) for the parent-injects-children pattern (GDScript).
