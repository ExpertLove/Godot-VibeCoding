...
Reference for `skills/particles-vfx/SKILL.md` — sprite-sheet animated particles via `ParticleProcessMaterial.AnimSpeed` / `CanvasItemMaterial.ParticlesAnim*`. **GDScript parity** (v1.6.0).
