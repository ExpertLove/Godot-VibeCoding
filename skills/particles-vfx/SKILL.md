...
> See [references/subemitters.md](references/subemitters.md) for trigger modes, scene setup, GDScript (v1.6.0 parity), and limitations.
...
> See [references/flipbook-animation.md](references/flipbook-animation.md) for the full setup with GDScript (v1.6.0 parity).
