---
name: godot-testing
description: Use when writing tests for Godot projects — TDD workflow with GUT and gdUnit4, covers both GDScript
---
...
| Feature               | GUT                              | gdUnit4                           |
|-----------------------|----------------------------------|-----------------------------------|
| Language              | GDScript-first, limited C#       | GDScript (first-class)       |
...
> See [references/tdd-workflow.md](references/tdd-workflow.md) for a worked GDScript example walking through all three steps on a HealthComponent.
...
> See [references/testing-patterns.md](references/testing-patterns.md) for full code on each pattern (GDScript where applicable).
