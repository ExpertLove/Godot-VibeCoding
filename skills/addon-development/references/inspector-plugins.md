...
Reference for `skills/addon-development/SKILL.md` — `EditorInspectorPlugin` for custom property widgets, `EditorResourcePicker` for typed resource pickers, and `EditorResourcePreviewGenerator` for custom thumbnails. 
